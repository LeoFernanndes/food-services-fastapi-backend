...
def test_list_recipe_ingredients_200(seed_data, client):
    response = client.get("/recipes-management/recipes/1/recipe-ingredients/")
    expected_result = [
        {
            "id": 1,
            "ingredient_id": 1,
            "quantity": 11,
            "ingredient_measurement_unit_id": 1,
            "recipe_id": 1
        },
        {
            "id": 2,
...
def test_get_recipe_ingredient_200(seed_data, client):
    response = client.get("/recipes-management/recipes/1/recipe-ingredients/1")
    expected_result = {
            "id": 1,
            "ingredient_id": 1,
            "quantity": 11,
...
def test_get_recipe_ingredient_404(seed_data, client):
    response = client.get("/recipes-management/recipes/1/recipe-ingredients/404")
    assert response.status_code == 404


def test_post_recipe_ingredient_201(seed_data, client):
...
def test_post_recipe_ingredient_404(seed_data, client):
    ...
    response = client.post("/recipes-management/recipes/404/recipe-ingredients", json=payload)
    assert response.status_code == 404
    
    
def test_post_recipe_ingredient_400(seed_data, client):
    payload = {
        "ingredient_id": 1,
        "quantity": 16,
        "ingredient_measurement_unit_id": 404,
        "recipe_id": 2
    }
    response = client.post("/recipes-management/recipes/1/recipe-ingredients", json=payload)
...
def test_put_recipe_ingredient_200(seed_data, client):
    payload = {
        "quantity": 16,
        "ingredient_measurement_unit_id": 2,
    }
...
def test_put_inexistent_recipe_ingredient_404(seed_data, client):
    ...
    response = client.put("/recipes-management/recipes/404/recipe-ingredients/1", json=payload)
    assert response.status_code == 404


def test_put_recipe_ingredient_404(seed_data, client):
    payload = {
        "quantity": 16,
        "ingredient_measurement_unit_id": 2,
    }
    response = client.put("/recipes-management/recipes/1/recipe-ingredients/404", json=payload)
    assert response.status_code == 404
    
    
def test_put_recipe_ingredient_400(seed_data, client):
    payload = {
        "quantity": 16,
        "ingredient_measurement_unit_id": 404,
    }
...
def test_delete_recipe_ingredient_204(seed_data, client):
    response = client.delete("/recipes-management/recipes/1/recipe-ingredients/1")
    assert response.status_code == 204


def test_delete_inexistent_recipe_ingredient_404(seed_data, client):
    response = client.delete("/recipes-management/recipes/404/recipe-ingredients/1")
    assert response.status_code == 404
    

def test_delete_inexistent_recipe_ingredient_404(seed_data, client):
    response = client.delete("/recipes-management/recipes/1/recipe-ingredients/404")
    assert response.status_code == 404
